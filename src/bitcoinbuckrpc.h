...
#ifndef _BITCOINBUCKRPC_H_
#define _BITCOINBUCKRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Bitcoinbuck is not connected
...
/**
 * Bitcoinbuck RPC command dispatcher.
 */
class CRPCTable
{
private:
