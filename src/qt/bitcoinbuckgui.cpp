...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/bitcoinbuck_testnet"));
            setWindowIcon(QIcon(":icons/bitcoinbuck_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/bitcoinbuck_testnet"));
#endif
            if(trayIcon)
            {
