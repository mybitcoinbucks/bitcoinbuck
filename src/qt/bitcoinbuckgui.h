#ifndef BITCOINBUCKGUI_H
#define BITCOINBUCKGUI_H
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitcoinbuck wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
