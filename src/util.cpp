                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No bitcoinbuck.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override bitcoinbuck.conf
...
// Format the subversion field according to BIP 14 spec (https://en.bitcoinbuck.it/wiki/BIP_0014)
